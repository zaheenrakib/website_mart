    ...
    return (
        <div className="rac_main_wrapper">
            <PageBanner 
                ...
                bannerImage="bg-[url('https://images.pexels.com/photos/196655/pexels-photo-196655.jpeg?auto=compress&cs=tinysrgb&w=600')]"
                pageDescription="Explore our collection of memorable moments and club activities"
            />

            {/* Hero Section */}
            <section className="py-32 bg-gradient-to-b from-[#0f0f0f] to-[#1a1a1a] relative overflow-hidden">
                ...
                <div className="container mx-auto px-4 relative">
                    <div className="text-center mb-24">
                        ...
                        <h2 className="text-5xl text-white font-light mb-8">Our Memories</h2>
...
const galleryImages = [
    ...
    },
    {
        ...
        category: "celebrations",
        date: "Sept 25, 2023",
        url: "https://images.unsplash.com/photo-1517457373958-b7bdd4587205?q=80&w=2069&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
    },
    {
        title: "Yoga Workshop",
        category: "sports",
